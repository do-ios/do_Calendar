 ...
 *
 * @see DOCalendarDataSource
 * @see DOCalendarDelegate
 * @see DOCalendarDelegateAppearance
 * @see DOCalendarAppearance
 * @see DOCalendar+DateTools
 */

//! Project version number for FSCalendar.
FOUNDATION_EXPORT double DOCalendarVersionNumber;

//! Project version string for FSCalendar.
FOUNDATION_EXPORT const unsigned char DOCalendarVersionString[];

typedef NS_ENUM(NSUInteger, DOCalendarScope) {
    DOCalendarScopeMonth,
    DOCalendarScopeWeek
};

typedef NS_ENUM(NSUInteger, DOCalendarScrollDirection) {
    DOCalendarScrollDirectionVertical,
    DOCalendarScrollDirectionHorizontal
};
 ...
 */
@protocol DOCalendarDataSource <NSObject>
 ...
 */
- (nullable NSString *)calendar:(DOCalendar *)calendar subtitleForDate:(NSDate *)date;

/**
 * Asks the dataSource for an image for the specific date.
 */
- (nullable UIImage *)calendar:(DOCalendar *)calendar imageForDate:(NSDate *)date;

/**
 * Asks the dataSource the minimum date to display.
 */
- (NSDate *)minimumDateForCalendar:(DOCalendar *)calendar;

/**
 * Asks the dataSource the maximum date to display.
 */
- (NSDate *)maximumDateForCalendar:(DOCalendar *)calendar;
 ...
 */
- (NSInteger)calendar:(DOCalendar *)calendar numberOfEventsForDate:(NSDate *)date;

/**
 * This function is deprecated
 */
- (BOOL)calendar:(DOCalendar *)calendar hasEventForDate:(NSDate *)date FSCalendarDeprecated(-calendar:numberOfEventsForDate:);
 ...
 */
@protocol DOCalendarDelegate <NSObject>
 ...
 */
- (BOOL)calendar:(DOCalendar *)calendar shouldSelectDate:(NSDate *)date;
 ...
 */
- (BOOL)calendar:(DOCalendar *)calendar shouldDeselectDate:(NSDate *)date;

/**
 * Tells the delegate a date in the calendar is deselected by tapping.
 */
- (void)calendar:(DOCalendar *)calendar didDeselectDate:(NSDate *)date;

/**
 * Tells the delegate the calendar is about to change the bounding rect.
 */
- (void)calendar:(DOCalendar *)calendar boundingRectWillChange:(CGRect)bounds animated:(BOOL)animated;

/**
 * Tells the delegate the calendar is about to change the current page.
 */
- (void)calendarCurrentPageDidChange:(DOCalendar *)calendar;

/**
 * These functions are deprecated
 */
- (void)calendarCurrentScopeWillChange:(DOCalendar *)calendar animated:(BOOL)animated FSCalendarDeprecated(-calendar:boundingRectWillChange:animated:);
- (void)calendarCurrentMonthDidChange:(DOCalendar *)calendar FSCalendarDeprecated(-calendarCurrentPageDidChange:);
 ...
 */
@protocol DOCalendarDelegateAppearance <NSObject>
 ...
 */
- (nullable UIColor *)calendar:(DOCalendar *)calendar appearance:(DOCalendarAppearance *)appearance fillDefaultColorForDate:(NSDate *)date;

/**
 * Asks the delegate for a fill color in selected state for the specific date.
 */
- (nullable UIColor *)calendar:(DOCalendar *)calendar appearance:(DOCalendarAppearance *)appearance fillSelectionColorForDate:(NSDate *)date;

/**
 * Asks the delegate for day text color in unselected state for the specific date.
 */
- (nullable UIColor *)calendar:(DOCalendar *)calendar appearance:(DOCalendarAppearance *)appearance titleDefaultColorForDate:(NSDate *)date;

/**
 * Asks the delegate for day text color in selected state for the specific date.
 */
- (nullable UIColor *)calendar:(DOCalendar *)calendar appearance:(DOCalendarAppearance *)appearance titleSelectionColorForDate:(NSDate *)date;

/**
 * Asks the delegate for subtitle text color in unselected state for the specific date.
 */
- (nullable UIColor *)calendar:(DOCalendar *)calendar appearance:(DOCalendarAppearance *)appearance subtitleDefaultColorForDate:(NSDate *)date;

/**
 * Asks the delegate for subtitle text color in selected state for the specific date.
 */
- (nullable UIColor *)calendar:(DOCalendar *)calendar appearance:(DOCalendarAppearance *)appearance subtitleSelectionColorForDate:(NSDate *)date;

/**
 * Asks the delegate for single event color for the specific date.
 */
- (nullable UIColor *)calendar:(DOCalendar *)calendar appearance:(DOCalendarAppearance *)appearance eventColorForDate:(NSDate *)date;

/**
 * Asks the delegate for multiple event colors for the specific date.
 */
- (nullable NSArray *)calendar:(DOCalendar *)calendar appearance:(DOCalendarAppearance *)appearance eventColorsForDate:(NSDate *)date;

/**
 * Asks the delegate for a border color in unselected state for the specific date.
 */
- (nullable UIColor *)calendar:(DOCalendar *)calendar appearance:(DOCalendarAppearance *)appearance borderDefaultColorForDate:(NSDate *)date;

/**
 * Asks the delegate for a border color in selected state for the specific date.
 */
- (nullable UIColor *)calendar:(DOCalendar *)calendar appearance:(DOCalendarAppearance *)appearance borderSelectionColorForDate:(NSDate *)date;

/**
 * Asks the delegate for a shape for the specific date.
 */
- (DOCalendarCellShape)calendar:(DOCalendar *)calendar appearance:(DOCalendarAppearance *)appearance cellShapeForDate:(NSDate *)date;

/**
 * These functions are deprecated
 */
- (DOCalendarCellStyle)calendar:(DOCalendar *)calendar appearance:(DOCalendarAppearance *)appearance cellStyleForDate:(NSDate *)date FSCalendarDeprecated(-calendar:appearance:cellShapeForDate:);
- (nullable UIColor *)calendar:(DOCalendar *)calendar appearance:(DOCalendarAppearance *)appearance fillColorForDate:(NSDate *)date FSCalendarDeprecated(-calendar:appearance:fillDefaultColorForDate:);
- (nullable UIColor *)calendar:(DOCalendar *)calendar appearance:(DOCalendarAppearance *)appearance selectionColorForDate:(NSDate *)date FSCalendarDeprecated(-calendar:appearance:fillSelectionColorForDate:);
...
IB_DESIGNABLE
@interface DOCalendar : UIView

/**
 * The object that acts as the delegate of the calendar.
 */
@property (weak, nonatomic) IBOutlet id<DOCalendarDelegate> delegate;

/**
 * The object that acts as the data source of the calendar.
 */
@property (weak, nonatomic) IBOutlet id<DOCalendarDataSource> dataSource;
 ...
 */
@property (assign, nonatomic) DOCalendarScrollDirection scrollDirection;
 ...
 */
@property (assign, nonatomic) DOCalendarScope scope;
 ...
 */
@property (readonly, nonatomic) DOCalendarAppearance *appearance;
 ...
 *
 */
@interface DOCalendar (DateTools)
 ...
 */
@interface DOCalendar (Deprecated)
@property (strong, nonatomic) NSDate *currentMonth FSCalendarDeprecated('currentPage');
@property (assign, nonatomic) DOCalendarFlow flow FSCalendarDeprecated('scrollDirection');
