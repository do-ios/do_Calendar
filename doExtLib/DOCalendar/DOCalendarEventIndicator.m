...
#import "CALayer+DOExtension.h"

@interface DOCalendarEventIndicator ()
...
@implementation DOCalendarEventIndicator
...
- (void)layoutSubviews
{
    ...
    if (_needsAdjustingViewFrame) {
        CGFloat diameter = MIN(MIN(self.fs_width, self.fs_height),DOCalendarMaximumEventDotDiameter);
